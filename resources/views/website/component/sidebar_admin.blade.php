...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('adminlte32/dist/css/adminlte.min.css')}}">
  <!-- overlayScrollbars -->
...
<!-- AdminLTE App -->
<script src="{{ asset('adminlte32/dist/js/adminlte.js') }}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{ asset('adminlte32/dist/js/demo.js') }}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('adminlte32/dist/js/pages/dashboard.js') }}"></script>
</body>
</html>

...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-primary elevation-4" style="color: black;">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info" style="color: black;">
          <a class="d-block" style="font-size:23px; color: black;">RQ Khairo Assyarifiyah</a>
        </div>
      </div>

      <!-- SidebarSearch Form buatnyarisearch-->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" >
            <a href="pages/calendar.html" class="nav-link">
              <i class="nav-icon far fa-calendar-alt d-none d-sm-inline-block"></i>
              <p>
                Calendar
